...
public class LocationManager {
    ...
    {
        LogHelper.log("startReceivingLocationUpdates");
        ...
        if (mLocationManager != null) {
            try {
                ...
                LogHelper.log(TAG, "fail to request location update, ignore", ex.getMessage());
            } catch (IllegalArgumentException ex) {
                LogHelper.log("provider does not exist " , ex.getMessage());
            }
            try {
                mLocationManager.requestLocationUpdates(
        ...
        if (mLocationManager != null) {
            for (int i = 0; i < mLocationListeners.length; i++) {
                try {
                    ...
                    LogHelper.logx(TAG, "fail to remove location listners, ignore", ex);
                }
            }
    ...
    private class LocationListener
        ...
        public void onLocationChanged(Location newLocation) {
            LogHelper.log("onLocationChanged : " +newLocation.getLatitude()+" : " + newLocation.getLongitude());
